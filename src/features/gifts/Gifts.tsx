    ...
    <Box background="main">
      <Flex alignItems="center" flexDirection="column" color="mainFont">
        ...
        >
          ...
          за любые денежные подарки или ценные подарки, которые помогут нам
          начать новую жизнь вместе. Но самое главное для нас - ваше присутствие
          на нашем особенном дне. Спасибо за понимание и с нетерпением ждем
          вашего приезда!
        </Text>
      </Flex>
    </Box>
